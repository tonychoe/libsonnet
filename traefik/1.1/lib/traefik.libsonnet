...
k {
  ...
  local tracingArgs = [
      ...
      '--tracing.jaeger.samplingType=%s' % $._config.traefik_tracing.jaeger_sampling_type,
      '--tracing.jaeger.samplingServerURL=%s' % $._config.traefik_tracing.jaeger_sampling_server,
  ],
  ...
  traefik_deployment:
    deployment.new($._config.traefik.release_name + '-traefik', $._config.traefik.replicas, $.traefik_container, {
      'app.kubernetes.io/name': 'traefik',
      'app.kubernetes.io/instance': $._config.traefik.release_name,
    }) +
